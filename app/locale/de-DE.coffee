module.exports = nativeDescription: "Deutsch (Deutschland)", englishDescription: "German (Germany)", translation:
  ...
  new_home:
    ...
    teachers: "Teachers!"   
    teachers_and_educators: "Lehrkräfte & Schüler"   
    class_in_box: "Finden Sie heraus wie unser Klassenraum-in-einer-Box in ihren Unterricht passt."   
    get_started: "Beginnen"   
    students: "Schüler:"   
    join_class: "Einer Klasse beitreten"   
    role: "Ihre Rolle:"   
    student_count: "Anzahl der Schüler:"   
    start_playing_for_free: "Jetzt kostenlos spielen!"   
    students_and_players: "Schüler und Spieler"   
    goto_classes: "Zu meinen Klassen gehen"   
    educator_wiki: "Lehrkraftwiki"   
    view_profile: "Mein Profil betrachten"   
    login_switch: "Haben Sie einen Account?"   
    check_out_wiki: "Schauen Sie sich unser neues Lehrerwiki an"   
    want_coco: "Wollen Sie CodeCombat an ihrer Schule nutzen?"   
    form_select_role: "Wählen Sie ihre primäre Rolle aus"   
    form_select_range: "Klassengröße auswählen" 
  ...
  nav:
    ...
    schools: "Schulen"
    educator_wiki: "Lehrkraftwiki"
    request_quote: "Eine Demo beantragen"
    get_involved: "Mitmachen"
    open_source: "Open source (GitHub)"
    support: "Support"
    faqs: "FAQs"
    help_pref: "Brauchen Sie Hilfe? Schreiben Sie eine Email an"
    help_suff: "und wir melden uns bei Ihnen!"
  ...
  play_level:
    ...
    tip_mistakes_proof_of_trying: "Fehler in deinem Code beweisen nur, dass du es versuchst."
    tip_adding_orgres: "Oger werden aufgerundet."
    tip_sharpening_swords: "Schwärter werden geschärft."
    tip_ratatouille: "Lasse dir von niemanden Grenzen setzen auf Grund deiner Herkunft. Die einzige Grenze ist deine Seele. - Gusteau, Ratatouille"
